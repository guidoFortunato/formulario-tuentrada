  ...
  return (
    <div>
      ...
      <select
        ...
        className={`bg-gray-50 border ${errorInput ? "border-red-500 focus:ring-red-500 focus:border-red-500" : "border-gray-300 focus:ring-blue-300 focus:border-blue-dark"} text-gray-900 text-sm rounded-lg w-full block p-2.5 mt-2`}
